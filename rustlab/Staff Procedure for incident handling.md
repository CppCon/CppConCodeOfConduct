...
Try to get as much of the incident in written form by the reporter. If you cannot, transcribe it yourself as it was told to you. The important information to gather include the following:
 ...
 - Identifying information (name/conference) of the participant doing the harassing
 - The behavior that was in violation
 - The approximate time of the behavior (if different than the time the report was made)
 - The circumstances surrounding the incident
 - Other people involved in the incident

Prepare an initial response to the incident. This initial response is very important and will set the tone for RustLab. Depending on the severity/details of the incident, please follow these guidelines:
...
Once something is reported to a staff member, immediately meet with Mena Marotta (conference chair). The main objectives of this meeting is to find out the following:
