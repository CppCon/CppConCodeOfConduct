...
```
https://www.papercall.io/golab2023
```
...
```
GoLab organizers are committed to ensure a safe and welcoming environment for all participants at all events.

We expect all attendees at GoLab to abide by its Code of Conduct in all venues throughout the conference, including ancillary events and official and unofficial social gatherings.
...
> As last year, GoLab and RustLab are uniting in a co-located conference! However there’s a Call For Proposals for each conference. This CFP is for GoLab only. Please refer to the [RustLab](https://rustlab.it) 2023 CFP for proposals to the Rust track.
...
If you would like to speak about a product of your company with more freedom, please consider giving a **sponsored talk**. You can contact us for further information at info@golab.io.
```
...
This year we are focusing even more on our planet and the environmental emergency. Thanks to our partner [Treedom](https://www.treedom.net) we'll grow a small forest as part of the GoLab + RustLab 2023 CO2 compensation initiative.
```
